...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: arial,helvetica,sans-serif; font-size: 26px; font-weight: 400;"><span><span><span><span><span><span><span>Ваш контракт отправлен!</span></span></span></span></span></span></span></h1>
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><strong>Уважаемый(ая) представитель турфирмы {{ $turfirma->name }},</strong></span></p>
<p style="font-size: 14px; line-height: 140%;"><br /><span style="font-size: 16px; line-height: 22.4px;">Мы рады сообщить, что к этому письму прикреплен ваш контракт с нашей компанией. Пожалуйста, ознакомьтесь с его содержанием. </span></p>
<p style="font-size: 14px; line-height: 140%;"><br />Информация о контракте:
   <br> Номер контракта: {{ $contract->number }} </br>
    <br>Дата подписания: {{ $contract->date->format('d-m-Y') }}</br>
    <br>Мы благодарим вас за сотрудничество и надеемся на плодотворное взаимодействие. </br></p>

<p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
<p style="font-size: 14px; line-height: 140%;">Если у вас возникнут вопросы или потребуется дополнительная информация, свяжитесь с нами по указанным ниже контактам.<span style="color: #ff0000; font-size: 14px; line-height: 19.6px;">(91) 313-69 95</span>, или <span style="color: #ff0000; font-size: 14px; line-height: 19.6px;"><a style="color: #ff0000;" href="mailto:odilorg@gmail.com" target="_blank" rel="noopener">odilorg@gmail.com</a></span></p>
<p style="font-size: 14px; line-height: 140%;"><br /><span style="font-size: 16px; line-height: 22.4px;">{{ $hotel->director_name }}</span><br /><strong> {{ $hotel->official_name }}</strong><br />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </p>
  </div>
...
<div align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:40px; v-text-anchor:middle; width:156px;" arcsize="10%"  stroke="f" fillcolor="#ff0000"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
    <a href="{{ asset('storage/contracts/' . $contract->file_name) }}" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ff0000; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
      <span style="display:block;padding:12px 40px;line-height:120%;"><strong><span style="font-size: 14px; line-height: 16.8px; font-family: Lato, sans-serif;">Скачать Контракт</span></strong></span>
    </a>
